...
class Signin extends React.Component {
    ...
    onSubmitSignIn = () => {
        fetch('http://localhost:3000/signin', {
            ...
            .then(user => { 
                if (user.id) { //did we recieve a user that exists
    ...
    render() {
        ...
        return(
            <article className="br3 ba dark-gray b--black-10 mv4 w-100 w-50-m w-25-l mw5 shadow-2 center">
                <main className="pa4 white-80">
                    <div className="measure">
                        ...
                        <input 
                            ...
                            className="b br2 ph3 pv2 input-reset white b--white bg-transparent  grow pointer f6 dib" 
                            type="submit" 
                            value="Sign in" />
                        </div>
